...
CLASS_ITEM_ROLLS = {
    ...
    # ("Spirit of the Assassin", "Spirit of the the Swarm"): ("Melee", "Health", "Grenade"),  # Guess, needs validation
    # ("Spirit of the Assassin", "Spirit of the the Claw"): ("Melee", "Health", "Class"),  # Guess, needs validation
    ...
    # ("Spirit of the Stag", "Spirit of the Claw"): ("Class", "Weapons", "Melee"),  # Guess, needs validation
